...
**Summary:**  The contemporary global political landscape is marked by the rise of right-wing movements. My dissertation argues that one key mechanism behind this trend is the superior execution of digital campaigns. This paper examines the Bharatiya Janata Party’s digital advantage on Facebook from 2020 to 2024, drawing on more than 54,000 ads from India’s six major parties. Three findings stand out. First, BJP ads are visually distinctive in ways that machine-learning models easily detect. Second, the party relies on a visual language that signals Hindu-majoritarian identity through saffron palettes, religious motifs, and leader-focused templates that center Narendra Modi. What is most striking is that these cues are often subtle rather than overt, yet they consistently convey ideological meaning without explicit messaging. Third, the BJP combines these design choices with fine-grained geographic targeting in rural constituencies, which allows the party to reach beyond its core urban base and scale identity-driven communication across diverse audiences.
